...
fun main() = repeat(readln().toInt()) {
    readln()
    val act = readln().split(' ')
    val cube = Array(6) { color -> Array(3) { IntArray(3) { color } } }
    val tmp = Array(3) { IntArray(3) { -1 } }
    ...
    val c = "wyrogb"
    println(cube[0].joinToString("\n") { it.joinToString("") { "${c[it]}" } })
}
